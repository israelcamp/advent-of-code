...
# TODO: ^ That was not me, I stole from another, one day I will come back to it
# Right now I am too fixated on my solution to be able to come up with another
...
def part2(puzzle_input):
    ...
    def init_values(i: int, x: int, y: int, carry: int) -> dict:
        x_values = {make_x(i): x, make_x(i - 1): carry}
        y_values = {make_y(i): y, make_y(i - 1): carry}
        return null_values | x_values | y_values

    operators = {"AND": __and__, "XOR": __xor__, "OR": __or__}
